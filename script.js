...
// MIDDELBURG
function loadVlissingen(){ 
    const requestMb = new XMLHttpRequest();
    requestMb.open("GET", "https://api.openweathermap.org/data/2.5/weather?lat=51.4537&lon=3.5709&units=metric&exclude=minutely,daily,alerts&appid="+myKey, true); 
